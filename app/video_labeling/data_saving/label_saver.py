...
class LabelSaver(ABC):

    IMAGE_PATH_COL = "Image path"
    COLUMN_NAME_X_FORMAT = "{}_x"
    COLUMN_NAME_Y_FORMAT = "{}_y"

    def __init__(self, canvases: List[LabelingCanvas], skeleton: Skeleton, file: str | IO[bytes]):
...
class ImagePathSaverMixin(LabelSaver):
    def __init__(self, canvases: List[LabelingCanvas], skeleton: Skeleton, file: str | IO):
